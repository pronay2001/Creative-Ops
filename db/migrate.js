...
INSERT INTO users (id, keka_id, name, email, role, designation, reports_to_name, joined_at, is_active, skills, capacity) VALUES
  ...
  ('u_content_market_intern', 'INT001', 'Video Team Intern', 'content.market@hoichoi.tv', 'video_editor', 'Intern - Video', 'Arnab Bhattacharjee', '2026-01-01', true, '{}', 0),
...
ALTER TABLE requests ADD COLUMN IF NOT EXISTS assigned_team TEXT;
